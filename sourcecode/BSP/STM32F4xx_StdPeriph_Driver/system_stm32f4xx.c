...
#if defined (DATA_IN_ExtSRAM) || defined (DATA_IN_ExtSDRAM) || defined (RTE_DEVICE_FSMC) || defined (RTE_DEVICE_FMC)  /* Keil */
static void SystemInit_ExtMemCtl(void); 
#endif /* DATA_IN_ExtSRAM || DATA_IN_ExtSDRAM || RTE_DEVICE_FSMC || RTE_DEVICE_FMC */                                 /* Keil */
...
/**
  ...
  * @retval None
  */ 
#if defined (RTE_DEVICE_FSMC) || defined (RTE_DEVICE_FMC)  /* Keil */
#ifdef RTE_DEVICE_FSMC
extern void FSMC_Setup (void);
#endif
#ifdef RTE_DEVICE_FMC
extern void FMC_Setup (void);
#endif
...
#endif /* RTE_DEVICE_FSMC || RTE_DEVICE_FMC */             /* Keil */
