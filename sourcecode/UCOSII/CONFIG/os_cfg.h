...
#define OS_EVENT_NAME_EN          1u   /*使能给信号量,互斥信号量,消息队列的命名 Enable names for Sem, Mutex, Mbox and Q                      */

#define OS_LOWEST_PRIO           63u   /*系统最低优先级 Defines the lowest priority that can be assigned ...         */
/* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            35u   /* 系统最大事件数Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS              5u   /* 系统最大的信号量集数Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART           0u   /* 内存块数目Max. number of memory partitions                             */
#define OS_MAX_QS                 5u   /* 队列控制块数目   Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS             12u   /* 任务最大数目Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1u   /* Include code for OSSchedLock() and OSSchedUnlock()           */

#define OS_TICK_STEP_EN           1u   /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC       1000u   /* 设置1s时间的节拍数Set the number of ticks in one second                        */
...
#define OS_FLAG_WAIT_CLR_EN       1u   /* 包含用于清除事件标志的等待代码Include code for Wait on Clear EVENT FLAGS                   */
#define OS_FLAGS_NBITS           16u   /* 信号列表 信号量集中使用 默认16位Size in #bits of OS_FLAGS data type (8, 16 or 32)            */
...
/* --------------------- TIMER MANAGEMENT --------------------- */
#define OS_TMR_EN                 1u   /* 软件定时器Enable (1) or Disable (0) code generation for TIMERS         */
